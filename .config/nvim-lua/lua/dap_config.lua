...
local function lldb_config(name, default_path)
  default_path = default_path or ''
  -- local full_default_path = vim.fn.getcwd() .. '/' .. default_path
  return {
    name = name,
    type = 'lldb',
    request = 'launch',
...
dap.configurations.cpp = {
  lldb_config("[CMake-lldb] C++ exe + Args", "/build/bin/"),
  gdb_config("[CMake-gdb] C++ exe + Args", "/build/bin/"),
}
dap.configurations.c = {
  lldb_config("[C-lldb] exe + Args"),
  gdb_config("[C-gdb] exe + Args"),
}

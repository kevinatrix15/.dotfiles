...
-- Telescope -------------------------------------------------------------------
vim.keymap.set('n', '<C-g>', ':Telescope live_grep_args<cr>', {})
-- vim.keymap.set('n', '<C-g>', ':Telescope live_grep<cr>', {})
vim.keymap.set('n', '<C-p>', ':Telescope find_files<cr>', {})
vim.keymap.set('n', '<C-h>', ':Telescope grep_string<cr>', {})
vim.keymap.set('n', '<leader>r', ':Telescope resume<cr>', {}) -- Open last search
-- vim.keymap.set('n', '<C-f>', ':Telescope resume<cr>', {}) -- Open last search
--------------------------------------------------------------------------------

-- CopilotChat -----------------------------------------------------------------
vim.keymap.set('n', '<leader>cc', ':CopilotChatToggle<cr>', {})
vim.keymap.set('n', 'C-cce', ':CopilotChatExplain<cr>', {})
vim.keymap.set('n', 'C-ccf', ':CopilotChatFix<cr>', {})
vim.keymap.set('n', 'C-cct', ':CopilotChatTests<cr>', {})
vim.keymap.set('n', 'C-cco', ':CopilotChatOptimize<cr>', {})
--------------------------------------------------------------------------------

-- DiffView -----------------------------------------------------------------
vim.keymap.set('n', '<leader>dvo', ':DiffviewOpen -uno<cr>', {})
vim.keymap.set('n', '<leader>dvc', ':DiffviewClose<cr>', {})
vim.keymap.set('n', '<leader>dvr', ':DiffviewRefresh<cr>', {})
--------------------------------------------------------------------------------
